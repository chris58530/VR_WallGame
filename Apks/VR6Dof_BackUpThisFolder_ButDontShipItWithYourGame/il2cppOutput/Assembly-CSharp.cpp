...
IL2CPP_EXTERN_C String_t* _stringLiteralBC91F7BEB929F0251479513D187BECB54996FFC2;
...
struct TouchManager_t38556C99556388530402BB02D83E19164E477D1C  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	// UnityEngine.InputSystem.InputAction TouchManager::getPositionAct
	InputAction_t1B550AD2B55AF322AFB53CD28DA64081220D01CD* ___getPositionAct_7;
...
IL_00a9:
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_21 = __this->___playerCam_4;
		NullCheck(L_21);
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_24 = __this->___playerCam_4;
		NullCheck(L_24);
		...
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
		Debug_DrawRay_mB172868181856F153732BB56C0BE1C58EE598F53(L_23, L_28, L_29, NULL);
		...
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_30 = __this->___leftCrossAnim_5;
		NullCheck(L_30);
		Animator_SetBool_m6F8D4FAF0770CD4EC1F54406249785DE7391E42B(L_30, _stringLiteral71C0C5D6DEFFF553F1A16F55E32CB5DD206B4779, (bool)0, NULL);
		// rightCrossAnim.SetBool("Focus", false);
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_31 = __this->___rightCrossAnim_6;
		NullCheck(L_31);
		Animator_SetBool_m6F8D4FAF0770CD4EC1F54406249785DE7391E42B(L_31, _stringLiteral71C0C5D6DEFFF553F1A16F55E32CB5DD206B4779, (bool)0, NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TouchManager_Awake_mF16F8C69C865C03D41E2D065503B44804BB80EBD (TouchManager_t38556C99556388530402BB02D83E19164E477D1C* __this, const RuntimeMethod* method) 
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteralBC91F7BEB929F0251479513D187BECB54996FFC2);
	...
	}
	{
		...
		__this->___playerInput_6 = L_0;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___playerInput_6), (void*)L_0);
		// getPositionAct = playerInput.actions["GetPosition"];
		PlayerInput_t5155B6508FE1937D9B2380CBA545FABE36A6F81F* L_1 = __this->___playerInput_6;
		NullCheck(L_1);
		...
		L_3 = InputActionAsset_get_Item_mF080081A5481241910DCB5A068AAFCE6E69AE581(L_2, _stringLiteralBC91F7BEB929F0251479513D187BECB54996FFC2, NULL);
		__this->___getPositionAct_7 = L_3;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___getPositionAct_7), (void*)L_3);
		// pressScreenAct = playerInput.actions["PressScreen"];
		PlayerInput_t5155B6508FE1937D9B2380CBA545FABE36A6F81F* L_4 = __this->___playerInput_6;
		NullCheck(L_4);
		...
		L_6 = InputActionAsset_get_Item_mF080081A5481241910DCB5A068AAFCE6E69AE581(L_5, _stringLiteralEFB2A546A7071D4E4C895A4E160A4CA500D7D54D, NULL);
		__this->___pressScreenAct_8 = L_6;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___pressScreenAct_8), (void*)L_6);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TouchManager_TapScreen_mDA6FF07DB4A8040F10397DBCDF7C5CD67A2A2602 (TouchManager_t38556C99556388530402BB02D83E19164E477D1C* __this, CallbackContext_tB251EE41F509C6E8A6B05EC97C029A45DF4F5FA8 ___0_context, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
	...
	}
	{
		// Debug.Log("Door Open");
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
		Debug_Log_m87A9A3C761FF5C43ED8A53B16190A53D08F818BB(_stringLiteral9EF6D620F529E8590E35720F0BF2201056EAD198, NULL);
